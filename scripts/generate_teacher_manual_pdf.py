...
SOURCE = ROOT / "docs" / "TEACHER_USER_MANUAL_ZH.md"
OUTPUT = ROOT / "docs" / "TEACHER_USER_MANUAL_ZH.pdf"
FONT_PATHS = [
    Path("/System/Library/Fonts/Supplemental/Arial Unicode.ttf"),
    Path("/System/Library/Fonts/STHeiti Light.ttc"),
    Path("/System/Library/Fonts/STHeiti Medium.ttc"),
]
FONT_NAME = "TeacherManualCJK"
...
def draw_footer(canvas, doc):
    ...
    canvas.drawRightString(doc.pagesize[0] - doc.rightMargin, 10 * mm, f"教师端用户手册  |  第 {canvas.getPageNumber()} 页")
    canvas.restoreState()
...
def main() -> None:
    ...
    doc = SimpleDocTemplate(
        ...
        title="教师端用户手册",
        author="Codex",
        subject=f"Generated on {datetime.now().isoformat(timespec='seconds')}",
    )
